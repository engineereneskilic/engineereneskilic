...
- **Web Technologies**
  ...
  - **Backend:** C#, ASP.NET Core, ASP.NET MVC, .NET Framework, GIT, API, Microservice, PHP, NodeJS, Docker, Kubernetes, RabbitMQ, Kafka, Postman, Swagger, RESTful, Identity, ElasticSearch, WebAPI
...
- **Project Management:** Agile, Scrum
- **Tools and Platforms:** Git, Visual Studio, Azure, Docker
- **Other:** ERP, CRM, CSM, OOP, Asynchronous/Multithread Programming, Design Pattern, SEO
